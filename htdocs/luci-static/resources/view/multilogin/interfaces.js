    ...
    render: function (results) {
        ...
        var view = E('div', { 'class': 'cbi-map' }, [
            ...
            E('div', { 'class': 'cbi-section' }, [
                E('legend', _('快捷生成虚拟接口')),
                E('div', { 'class': 'cbi-section-descr' },
                    _('指定物理接口和数量，自动创建 macvlan 设备、逻辑接口（DHCP）、防火墙 WAN 区域绑定，以及 mwan4 负载均衡配置。所有生成的条目均带有 auto_ 前缀，可安全重新生成（会覆盖旧配置）。生成完成后，请前往「自动登录配置」页面为每个接口配置对应的登录实例。')
                ),
                E('div', { 'class': 'cbi-section-node' }, [
                    ...
                    E('div', { 'class': 'cbi-value' }, [
                        ...
                        E('div', { 'class': 'cbi-value-field' }, [
                            ...
                            E('div', { 'class': 'cbi-value-description' }, _('生成 N 个 macvlan 虚拟接口，及对应的 mwan4 路由与策略配置（会覆盖旧配置）'))
                        ])
                    ]),
                    // Button
                    E('div', { 'class': 'cbi-value' }, [
